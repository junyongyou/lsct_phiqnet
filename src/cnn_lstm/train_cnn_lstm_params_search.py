...
if __name__ == '__main__':
    args = {}
    args['result_folder'] = r'C:\vq_datasets\results\cnn_lstm_resnet'
    if not os.path.exists(args['result_folder']):
        os.makedirs(args['result_folder'])
    args['vids_meta'] = r'C:\lsct_phiqnet\src\lsct\meta_data\all_vids.pkl'
    args['meta_file'] = r'C:\lsct_phiqnet\src\lsct\meta_data\all_video_mos_Resnet50.csv'
    ...
    result_record_file = os.path.join(args['result_folder'], 'all_nochunks.csv')
    runs = 5
                ...
                for k, mlp_params in enumerate(mlp_params_range):
                    ...
                    record_file.write(
                        'Run: {}, CNN: {}, LSTM: {}, MLP: {}, plcc: {}, rmse: {}, srocc: {}\n'.format(
                            k, cnn_filters, lstm_params, mlp_params, plcc, rmse, srocc))
