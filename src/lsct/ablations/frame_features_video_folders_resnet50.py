...
if __name__ == '__main__':
    ...
    feature_folder = r'...\\model_weights\frame_features_resnet50'

    # Use None that ResNet50 will download ImageNet Pretrained weights or specify the weight path
    video_frame_features = CalculateFrameQualityFeaturesResnet50(model_weights=None, #.\resnet50_weights_tf_dim_ordering_tf_kernels_notop.h5',
