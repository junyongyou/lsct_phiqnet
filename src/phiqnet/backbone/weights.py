from phiqnet.backbone.resnet_config import get_submodules_from_kwargs
...
def load_model_weights(model, model_name, dataset, classes, include_top, **kwargs):
    ...
    if weights:
        ...
        if include_top and weights['classes'] != classes:
            raise ValueError('If using `model_weights` and `include_top`'
        ...
        raise ValueError('There is no model_weights for such configuration: ' +
